...
namespace QuestPDF.Elements.Table
{
    ...
    {
        public static void PlanCellPositions(
            this Table table
        )
        {
        ...
        private static void PlanCellPositions(
            int columnsCount
        ...
        private static IEnumerable<(int x, int y)> GenerateCoordinates(
            int columnsCount
        ...
        private static bool CollidesWithAnyOf(
            this TableCell cell
            , ICollection<TableCell> neighbours
        )
        {
            return neighbours.Any(cell.CollidesWith);
        }

        private static void SetPartialLocation(
            this TableCell cell
        )
        {
