...
namespace QuestPDF.Drawing
{
    public static class DocumentGenerator
    {
        ...
        public static ICollection<byte[]> GenerateImages(IDocument document)
        {
            var metadata = document.GetMetadata();
        ...
        public static void RenderDocument<TCanvas>(TCanvas canvas, IDocument document)
        ...
        public static void RenderPass<TCanvas>(PageContext pageContext, TCanvas canvas, Container content, DocumentMetadata documentMetadata, DebuggingState? debuggingState)
            where TCanvas : ICanvas, IRenderingCanvas
        {
