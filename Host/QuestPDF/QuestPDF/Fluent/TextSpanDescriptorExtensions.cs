...
namespace QuestPDF.Fluent
{
    public static class TextSpanDescriptorExtensions
    {
        ...
        public static T BackgroundColor<T>(
            this T descriptor
            , string value
        )
            where T : TextSpanDescriptor
        ...
        public static T Strikethrough<T>(
            this T descriptor
            , bool value = true
        )
            where T : TextSpanDescriptor
        ...
        public static T NormalWeight<T>(
            this T descriptor
        )
            where T : TextSpanDescriptor
        {
