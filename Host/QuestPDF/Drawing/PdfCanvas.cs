...
namespace QuestPDF.Drawing
{
    ...
    {
        public PdfCanvas(Stream stream, Infrastructure.DocumentMetadata documentMetadata, DocumentSettings documentSettings) 
            : base(CreatePdf(stream, documentMetadata, documentSettings))
        {
            
        }

        private static SKDocument CreatePdf(Stream stream, Infrastructure.DocumentMetadata documentMetadata, DocumentSettings documentSettings)
        {
            try
            {
        ...
        private static SKDocumentPdfMetadata MapMetadata(Infrastructure.DocumentMetadata metadata, DocumentSettings documentSettings)
        {
