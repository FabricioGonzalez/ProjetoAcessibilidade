...
namespace ProjectAvalonia.Project.Components.ProjectExplorer.TemplateSelectors;
public class ExplorerItemTemplateSelector : IDataTemplate
{
    ...
    public IControl Build(object param)
    {
        ...
        return AvailableTemplates[((ExplorerItem)param).Type.ToString()].Build(param); // finally we look up the provided key and let the System build the DataTemplate for us
    }
    ...
    public bool Match(object data)
    {
        ...
        return data is ExplorerItemType                        // the provided data needs to be our enum type
