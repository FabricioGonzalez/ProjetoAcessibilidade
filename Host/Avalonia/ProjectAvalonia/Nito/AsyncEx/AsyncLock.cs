...
/// <remarks>
///     <para>
///         This is the <c>async</c>-ready almost-equivalent of the <c>lock</c> keyword or the
///         <see cref="System.Threading.Mutex" /> type, similar to
...
public sealed class AsyncLock
{
    ...
    public AsyncLock(
        IAsyncWaitQueue<IDisposable>? queue
    )
    {
    ...
    private Task<IDisposable> RequestLockAsync(
