    ...
    where T : IDisposable
{
    ...
    public static implicit operator Task<T>(
        AwaitableDisposable<T> source
    )
    {
    ...
    {
        return _task.ConfigureAwait(continueOnCapturedContext: continueOnCapturedContext);
    }
}